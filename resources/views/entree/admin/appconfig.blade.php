          ...
          <div class="row">
            <div class="col-md-10 col-xs-12">
              ...
              <div class="form-group">
                <label for="abbr" class="col-sm-2 control-label">
...
var resources = new Vue({
  el: '#photoprofile',
  data: {
    image: "{{ asset(data_get($data,'logo',false)) }}",
    newPhoto: "{{ asset(data_get($data,'logo',false)) }}",
    favicon: "{{ asset(data_get($data,'favicon',false)) }}",
    newFav: "{{ asset(data_get($data,'favicon',false)) }}",
    padRight: '',
    photo:'',
    fwidth: '16',
    width: '200',
