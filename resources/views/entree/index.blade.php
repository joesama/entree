    ...
    <div class="row" style="margin-top:50px">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                {!! Form::open(['url' => handles('threef/entree::login'), 'action' => 'POST', 'class' => 'form-signin']) !!}
                <label class="sr-only">Email</label>
                {!! Form::input('text', 'username', old('username'), ['required' => true, 'tabindex' => 1, 'class' => 'form-control', 'autofocus', 'placeholder' => trans('threef/entree::entree.login.username')]) !!}
				{!! $errors->first('email', '<p class="help-block">:message</p>') !!}
				<label class="sr-only">Password</label>
                {!! Form::input('password', 'password', '', ['required' => true, 'tabindex' => 2, 'class' => 'form-control', 'placeholder' => trans('threef/entree::entree.login.password')]) !!}
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit">{{ trans('threef/entree::entree.login.button.signin') }}</button>
                <label class="checkbox text-right">
					<p class="help-box">
						<a href="{!! handles('entree::forgot') !!}" class="pull-left" style="display:inline">
							{{ trans('threef/entree::entree.login.forgot-password') }}
						</a>
