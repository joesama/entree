            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="input-group">
                  <input type="text" class="form-control col-sm-8 input-sm" name="search" v-model="searchQuery" placeholder="{{ trans('threef/entree::datagrid.search') }}" value="{{ request()->get('search') }}">
